...
describe Marver::DataContainer do
  ...
  let(:response_with_multiple_results) { Marver::API::Response.new("{ \"code\": 200, \"status\": \"Ok\", \"etag\": \"ec5ab621cf3760eb6f2df2e6270ccb56c6debfb7\", \"data\": { \"offset\": 0, \"limit\": 20, \"total\": 2, \"count\": 1, \"results\": [1]}}") }
